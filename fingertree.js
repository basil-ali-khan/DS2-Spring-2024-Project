...
// the outer module is used to load data based on environment used, e.g. browser or node
...
(function (root, factory) {
     ...
     * used to create an object (fallback function in case browser doesn't support object.create)
     */
